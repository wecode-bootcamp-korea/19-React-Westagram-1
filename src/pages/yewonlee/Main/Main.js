...
class Main extends Component {
    constructor() {
        ...
        this.state = {
            commentValue: "",
            commentLine: [{text: "Hello React!!!"}, {text: "🤮"}],
        }
    }
                            ...
                            <article>
                                ...
                                <div className="article-contents">
                                    <div className="likes-number">
                                        <span><strong>aineworld</strong>님 <strong>외 10명</strong>이
                            좋아합니다</span>
                                    </div>
                                    <div className="caption">
                                        <span>함께해서 >wecode 18기 위니또 소식🥰⠀ 벌써 위코드에 오신지 한
                                        달이나 지나 두달차를 보내고계신 18기 분들 시간이 정말
                            빠르게 흘러가는 것 같아요 ✨...</span>
                                        <span id="caption-more">더 보기</span>
                                    </div>
                                    <span id="time">54분 전</span>
                                </div>
                                <Comment commentLine={this.state.commentLine} commentValue={this.state.commentValue}/>
                                    ...
                                    <ul className="profile-list">
                                        <li className="profile-info-description">
                                            ...
                                            <div className="profile-info-texts">
                                                ...
                                                <span className="user-description">swoon님 외 1명이 팔로우합니다</span>
                                            </div>
                                        ...
                                        <li className="profile-info-description">
                                            ...
                                            <div className="profile-info-texts">
                                                ...
                                                <span className="user-description">canon.mj님 외 5명이 팔로우합니다</span>
                                            </div>
                                            <button className="follow-button">팔로우</button>
                                        </li>
                                        <li className="profile-info-description">
                                            ...
                                            <div className="profile-info-texts">
                                                ...
                                                <span className="user-description">tennistv님 외 12명이 팔로우합니다</span>
                                            </div>
                                            <button className="follow-button">팔로우</button>
                                        </li>
                                    </ul>
